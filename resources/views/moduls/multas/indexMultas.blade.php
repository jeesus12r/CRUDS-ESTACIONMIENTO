        ...
        <div class="row"> 
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="{{ route('createMultas') }}" class="btn btn-primary">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form id="frmDatos-{{ $item->id }}" action="{{ route('eliminarMultas', $item->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')

                                        <a href="{{ route('showMultas', $item->id) }}" class="btn btn-info">
                                            <i class="fa-solid fa-list-ul"></i> Mostrar
                                        </a>
                                        @if(Auth::user()->rol === 'admin')
                                        <a href="{{ route('editMultas', $item->id) }}" class="btn btn-warning">
